        ...
        <div class="testimonial-section">
            ...
            <template>
                <div class="center grid">
                    <vs-row>
                        <vs-col :key="index" v-for="col, index in comments" vs-type="flex" vs-justify="center" vs-align="center" w="6">
                            <vs-card class="animated fadeInLeft" style="margin-bottom: 30px!important; max-width: 100% !important;">
                                ...
                                <template #text>
                                    <p>{{col.preview}}</p>
                                    <br />
                                    <vs-button primary icon @click="$router.push('/login/?tase=' + col.tase)" style="color: blue important;">
                                        {{col.ttase}}
                                    </vs-button>
                                </template>
