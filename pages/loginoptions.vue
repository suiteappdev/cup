 ...
 <div class="wrapper">
        <div class="service-page-section">
            <h1 class="text-center cases animated bounceInRight"></h1>
            <template>
                    ...
                    <vs-row>
                        <vs-col vs-type="flex" vs-justify="center" vs-align="center"  w="6" sm="12" xs="12">
                            <vs-card class="animated fadeInLeft" style="margin-bottom: 30px!important; max-width: 100% !important;">
                                ...
                                <template #text>
                                    <p>Si eres cliente solo ingresa con tus credenciales.</p>
                                    <br />
                                    <vs-button primary icon block @click="$router.push('login')" style="color: blue important;">
                                        Soy Cliente
                                    </vs-button>
                                </template>
        ...
        comments : [
                {
                    ...
                    ttase : 'Si eres cliente solo ingresa con tus credenciales.',
                },
                {
                    link : 'services', 
                    name : 'Es tu primera asesoria?', 
                    //image : `${require(`~/assets/images/asesoriapreferencial.jpeg`)}`,
                    ttase : 'Si es tu primer préstamo asesoria.', 
                },
            ],
      })
    }
